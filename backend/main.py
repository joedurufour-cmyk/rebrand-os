...
<style>
  * {{ margin: 0; padding: 0; box-sizing: border-box; }}
  ...
  h3 {{ font-size: 11pt; font-weight: bold; margin: 8px 0 2px; }}
  p {{ margin-bottom: 6px; }}
...
<body>
<div class="header">
  <h1>{req.candidate_name}</h1>
  <div class="meta">Generated by REBRAND.OS · {datetime.utcnow().strftime('%Y-%m-%d')}</div>
</div>
{_text_to_html(req.content)}
</body>
</html>"""
